...
library(logr)
log_open("./02_create_visualizations.log")
...
fig_ae_severity_distribution_by_treatment <- generate_ae_severity_barchart(
    data = adae,
    figure_path = "./ae_figure_barchart_severity_distribution_by_treatment.png"
)
fig_ae_most_frequent_adverse_events <- generate_ae_frequency_dotplot(
    data = adae,
    n_top = 10,
    figure_path = "./ae_figure_dotplot_top_most_frequent_adverse_events.png"
)
